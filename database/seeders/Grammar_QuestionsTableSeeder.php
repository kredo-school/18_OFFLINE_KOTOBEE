...
class Grammar_QuestionsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('grammar_questions')->insert([
            ...
            ['id' => 2, 'game_id'=>3, 'created_by_admin_id'=>1, 'stage_id'=>1, 'note'=>'stage_1', 'image_url'=>'/storage/images/game_images/grammar/stage_1/correct_images/q_2.png', 'correct_sentence'=>'さる が バナナ を 食べます', 'created_at'=>Carbon::now(), 'updated_at'=>Carbon::now()],
