    ...
    <div class="controls">
        <button id="prev" class="arrow-btn">
            <svg viewBox="0 0 30 30" class="arrow-icon" aria-hidden="true">
                <path
                    d="M14.8438 29.6878L1.12057e-05 14.844L14.8438 0.000266552L18.5085 3.63663L9.9716 12.1736H29.233V17.5145H9.9716L18.5085 26.0372L14.8438 29.6878Z" />
            </svg>
        </button>
        ...
        <button id="next" class="arrow-btn">
            <svg viewBox="0 0 30 30" class="arrow-icon" aria-hidden="true">
                <path
                    d="M14.3891 -0.000266403L29.2329 14.8435L14.3891 29.6872L10.7244 26.0509L19.2613 17.5139L-5.72205e-05 17.5139V12.173H19.2613L10.7244 3.6503L14.3891 -0.000266403Z" />
            </svg>
        </button>
    </div>
